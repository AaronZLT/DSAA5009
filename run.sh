...
CUDA_VISIBLE_DEVICES=4,5,6,7 accelerate launch train.py --base_model $ALBERT_BASE_CHINESE --train_dataset $TRAIN_DATASET --eval_dataset $EVAL_DATASET --test_dataset $TEST_DATASET --output_dir /mnt/sdb/zhanglongteng/sdd/zhanglongteng/tmp/kuairec/attn-8e-3 --per_device_train_batch_size 1024 --per_device_eval_batch_size 128 --num_train_epochs 3 --learning_rate 8e-3
